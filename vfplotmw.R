vfplotmw <- function( vf, plotType, notSeenAsBlack = TRUE, newWindow = FALSE,
...
# window rescale is set to fixed to ensure re-sizing window doesn't re-size the plot
  ...
  vfplotlocmw( cloneDev, eye = vf$seye, patternMap = patternMap, outerColor = plotColor,
