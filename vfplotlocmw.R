vfplotlocmw <- function( vals, eye, patternMap, outerColor, innerColor = NULL, bs = NULL,
                         axesCol = "black", txtfont = "mono", pointsize = 7, txtcolor = NULL,
                         xmin = -29, xmax = 29, ymin = -29, ymax = 29,
                         outerSymbol = "circles", innerSymbol = "circles", outerSize = 1, innerSize = 1,
...
# control axes
  axis( 1, pos = 0, labels = FALSE, lwd.ticks = 0, at = c( xmin, xmax ), col = axesCol )
  axis( 2, pos = 0, labels = FALSE, lwd.ticks = 0, at = c( ymin, ymax ), col = axesCol )  
